...
def _load_df_any(ticker: str):
    ...
    # 2. Cache forex (strip C: prefix kalau ada)
    clean = ticker.removeprefix("C:")
    df = forex_cache_load(clean)
    if df is not None:
        return df
